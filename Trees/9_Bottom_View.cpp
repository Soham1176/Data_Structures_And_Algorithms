//{ Driver Code Starts
// refer:https://www.youtube.com/watch?v=s1d8UGDCCN8&t=2984s&ab_channel=CodeHelp-byBabbar
...
class Solution {
  public:
    ...
    void BottomViewTraversal(Node* root,int h)
    {
